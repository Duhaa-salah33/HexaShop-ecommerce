...
<head>
    ...
    <title>Hexa shop - quantity available</title>
    <style type="text/css">
    label
    {
                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    {{-- <div class="col-xl-9 col-lg-12 col-md-6 col-sm-12 col-12">
                        <div class="card" style="text-align:center">
                            ...
                            <div class="col-xl-9 col-lg-12 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header" style="text-align: center">Product availability</h5>
                                    <div class="card-body p-0">
                            ...
                            <a href="{{url('All-products')}}" class="btn btn-dark">get back</a>
                            <!-- ============================================================== -->
